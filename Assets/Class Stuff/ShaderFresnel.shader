Shader "Unlit/ShaderFresnel" // shader name  - shader1 under shader category - Unlit
{
    ...
    Properties
    {
        ...
        _Float("PowerModifier", Float) = 2 //with a specified range.
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float3 color = dot(i.worldNormal, i.viewDirection);
                float4 FinalColor = float4(color, 1);
                FinalColor = 1 - saturate(FinalColor);
                FinalColor = pow(FinalColor, 2);
                return FinalColor;
            }
            ENDCG
        }
